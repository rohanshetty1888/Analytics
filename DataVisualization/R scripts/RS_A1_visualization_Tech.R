...
# Part (a)  : Data Visualization for Sector "Technology"
...
g <- ggplot(data = TechData, aes(x = Company.Advertising, y = Brand.Revenue)) + 
  ...
  labs(title = "Technology",y="Brand Revenue in Billions of $",
...
gtech <- gg + geom_text(aes(label=Brand,col=Brand),hjust=0.5,vjust=2)
